...
namespace Ini.Test
{
    ...
    public class TestConfigWriter
    {
        ...
        public void Init()
        {
			...
			var configWriterLogger = Substitute.For<IConfigWriterEventLogger>();
			configWriterLogger.ConfigValidatiorLogger.Returns(Substitute.For<IConfigValidatorEventLogger>());
			...
			this.configWriter = new ConfigWriter(configWriterLogger);
        }
