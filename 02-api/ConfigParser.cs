...
namespace IniConfig
{
	public interface IConfigBacklog
	{
	...
	public class ConsoleBacklog : IConfigBacklog
	{
	...
	public class ConfigParser
	{
		...
		public Config Parse(StreamReader reader, IConfigBacklog backlog)
		{
			Config result = new Config(reader.CurrentEncoding);
			Section section = result.defaultSection;
			int lineIndex = 0;
		...
		private void ParseOption(string option, int lineIndex, Section section, IConfigBacklog backlog)
		{
